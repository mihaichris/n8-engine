...
public class IndexCommands {
    ...
    public Integer index() {
        ...
        URL assemblerResource = getClass().getClassLoader().getResource("assembler/assembler-lucene.ttl");
        URL rdfDataResource = getClass().getClassLoader().getResource("data/data.ttl");
